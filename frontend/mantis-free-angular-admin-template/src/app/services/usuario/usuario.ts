...
export class UsuarioService {
  ...
  guardar(tipo: Usuario): Observable<ApiResponse<boolean>> {
    return this.http.post<ApiResponse<boolean>>(`${this.apiUrl}/RegistrarUsuario`, tipo);
  }

  // Actualizar un registro existente
  actualizar(tipo: Usuario): Observable<ApiResponse<boolean>> {
